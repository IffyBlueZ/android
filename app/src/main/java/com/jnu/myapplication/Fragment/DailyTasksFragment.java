...
public class DailyTasksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(daily_tasks.size() == 0)
        {
            ...
            TextView textView1 = root.findViewById(R.id.empty_tasks1);
            TextView textView2 = root.findViewById(R.id.empty_tasks2);
            textView1.setText("无任务");
            textView2.setText("        昨天，你说明天");
            return root;
        }
   ...
   public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case 0:
                ...
                AlertDialog.Builder remind = new AlertDialog.Builder(this.getContext());
                remind.setTitle("添加提醒");
                remind.setMessage("已添加……");
                remind.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
                ...
                break;
            case 1:
                AlertDialog.Builder delete = new AlertDialog.Builder(this.getContext());
                delete.setTitle("删除");
                delete.setMessage("是否要删除项目");
                delete.setPositiveButton("是", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                ...
                delete.setNegativeButton("否", new DialogInterface.OnClickListener() {
                    @Override
    ...
    public class TasksAdapter extends RecyclerView.Adapter<DailyTasksFragment.TasksAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
            ...
            public void onCreateContextMenu(ContextMenu menu, View v,
                ...
                menu.add(0, 1, this.getAdapterPosition(), "删除项目");
            }
